...
app._models.post= (function () {
    function Post(requester){
    ...
    Post.prototype.getPost = function(id){
        ...
        this._requester.get('classes/Post/' + id+ '?include=author') // + '?include=author,headerImage'
